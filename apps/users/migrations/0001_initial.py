# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2017-10-07 19:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', 'man'), ('female', 'woman')], default='female', max_length=20)),
                ('address', models.CharField(default='', max_length=100)),
                ('mobile', models.CharField(blank=True, max_length=10, null=True)),
                ('image', models.ImageField(default='image/default', upload_to='image/%Y/%m')),
